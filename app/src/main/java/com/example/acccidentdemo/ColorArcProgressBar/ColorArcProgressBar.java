package com.example.acccidentdemo.ColorArcProgressBar;
...
public class ColorArcProgressBar extends View {
     ...
     *
     */
    private Integer firstColor = Color.GREEN;
    private Integer secoundColor = Color.YELLOW;
    private Integer thirdColor = Color.RED;
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        colors = new int[]{firstColor, secoundColor, thirdColor, thirdColor};
     ...
     * @param color
     */
    public void setColorOnProgressStatus(int[] color){
        this.colors = color;
    }
    ...
    public Integer getSecoundColor() {
        return secoundColor;
    }

    public void setSecoundColor(Integer secoundColor) {
